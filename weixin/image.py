...
for friend in friends:
    ...
    fileImage = open("C:/Users/chenbing/python/img" + "/" + str(num) + ".jpg",'wb') #将好友头像下载到本地文件夹
    fileImage.write(image)
    fileImage.close()
    num += 1

#将微信图像进行拼接
dirs = os.listdir("C:/Users/chenbing/python/img")
...
for i in range(0,len(dirs)): 
    try:
        imageOfFriends = Image.open("C:/Users/chenbing/python/img" + "/" + str(i) + ".jpg") #打开一张照片，PIL库的应用
    except IOError:
        print ("error")
    else:
